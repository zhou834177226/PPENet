...
def do_train(
    ...
    for epoch in range(0, max_epoch):
        ...
        if is_main_process():
            ...
            # cls1_loss_epoch_mean = sum(cls1_loss_epoch)/len(cls1_loss_epoch)
            # reg1_loss_epoch_mean = sum(reg1_loss_epoch)/len(reg1_loss_epoch)
            # ad1_loss_epoch_mean = sum(ad1_loss_epoch)/len(ad1_loss_epoch)
            # cpt1_loss_epoch_mean = sum(cpt1_loss_epoch)/len(cpt1_loss_epoch)
            #
            # cls2_loss_epoch_mean = sum(cls2_loss_epoch)/len(cls2_loss_epoch)
            # reg2_loss_epoch_mean = sum(reg2_loss_epoch)/len(reg2_loss_epoch)
            # ad2_loss_epoch_mean = sum(ad2_loss_epoch)/len(ad2_loss_epoch)
